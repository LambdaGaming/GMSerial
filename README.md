# GMSerial
 Formerly known as Arduino Gmod Interface. GMSerial is an experimental binary module for Garry's Mod that allows the game to communicate with serial devices (primarily Arduinos), and vice versa. This repo contains the base addon, the binary module, and a Wiremod tool. The module is based on a modified version of the [SerialPort library.](https://github.com/manashmandal/SerialPort) It's available for the 64-bit version of the game on Windows.
...
# Using the Wiremod Tool
 ...
 - The delays between reads and writes.
...
3. Run `build_windows.bat`. The dll files will be in the src folder.
